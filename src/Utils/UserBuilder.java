...
public record UserBuilder() {
     ...
     */
    private String[] ResultDataValidator(ResultSet rst, int capacity) throws SQLException {
     ...
     */
    public User CreateNewUserFromRST(ResultSet rst, int capacity) throws SQLException {
     ...
     */
    public User CreateNewUserFromSTR(String datos) {
